...
"""Define entrypoint to run tasks for RADIO distillation."""

import argparse
from nvidia_tao_pytorch.multimodal.radio import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "RADIO",
        add_help=True,
        description="Train Adapt Optimize entrypoint for multi-teacher distillation",
    )
    ...
    # Launch the subtask.
    launch(vars(args), unknown_args, subtasks, network="radio")
