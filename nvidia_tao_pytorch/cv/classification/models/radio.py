...
class c_radio_p1_vit_huge_patch16_224_mlpnorm(nn.Module):
    """
    CRADIO p1 ViT Large model
    """
...
@MODELS.register_module()
class c_radio_p2_vit_huge_patch16_224_mlpnorm(nn.Module):
    """
    CRADIO p2 ViT Large model
    """
...
@MODELS.register_module()
class c_radio_p3_vit_huge_patch16_224_mlpnorm(nn.Module):
    """
    CRADIO p3 ViT Large model
    """
