...
"""Dilated Neighborhood Attention Transformer (DiNAT) backbone implementation."""
...
class ConvDownsampler(nn.Module):
    ...
    def forward(self, x):
        """Forward pass through downsampler."""
...
class NATLayer(nn.Module):
    ...
    def forward(self, x):
        """Forward pass through NAT layer."""
...
class NATBlock(nn.Module):
    """Neighborhood Attention Transformer block."""
    ...
    def forward(self, x):
        """Forward pass through NAT block."""
...
class DiNAT(nn.Module):
    ...
    def forward(self, x):
        """Forward pass through DiNAT backbone."""
        x = self.forward_embeddings(x)
        return self.forward_tokens(x)


class D2DiNAT(DiNAT):
    """DiNAT backbone for Detectron2 integration."""
    ...
    def forward(self, x):
        """Forward pass through D2DiNAT backbone."""
        assert (
            x.dim() == 4
    ...
    def output_shape(self):
        """Get output shape specification."""
        from nvidia_tao_pytorch.cv.oneformer.model.pixel_decoder.fpn import ShapeSpec
