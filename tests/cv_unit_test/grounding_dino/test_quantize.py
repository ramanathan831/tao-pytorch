...
"""Test cases for Grounding DINO quantization functionality."""
...
def test_dataset_config_has_quant_calibration_data_sources():
    """Test that GDINODatasetConfig has quant_calibration_data_sources field."""
    config = GDINODatasetConfig()
    assert hasattr(config, 'quant_calibration_data_sources'), (
        "GDINODatasetConfig should have quant_calibration_data_sources field"
    )
