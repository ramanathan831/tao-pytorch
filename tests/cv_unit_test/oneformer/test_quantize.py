...
"""Test cases for OneFormer quantization functionality."""
...
def test_dataset_config_has_quant_calibration_dataset():
    """Test that OneFormerDatasetConfig has quant_calibration_dataset field."""
    data_config = OneFormerDatasetConfig()
