...
"""Test cases for SegFormer quantization functionality."""
...
def test_dataset_segment_config_has_quant_calibration_dataset():
    """Test that SFDatasetSegmentConfig has quant_calibration_dataset field."""
    data_config = SFDatasetSegmentConfig()
