...
"""Test cases for Visual ChangeNet quantization functionality."""
...
@pytest.mark.cv_unit
def test_dataset_segment_config_has_quant_calibration_dataset():
    """Test that CNDatasetSegmentConfig has quant_calibration_dataset field."""
    data_config = CNDatasetSegmentConfig()
