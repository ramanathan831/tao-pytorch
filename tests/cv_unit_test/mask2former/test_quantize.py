...
"""Test cases for Mask2Former quantization functionality."""
...
def test_dataset_config_has_quant_calibration_dataset():
    """Test that Mask2FormerDatasetConfig has quant_calibration_dataset field."""
    data_config = Mask2FormerDatasetConfig()
